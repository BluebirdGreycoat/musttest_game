...
for k = 1, LAYER_COUNT do
	ab.create_2d_noise("cave1_" .. k .. "_route", {
		offset = 0,
		scale = 1,
	...
	ab.create_2d_noise("cave1_" .. k .. "_height", {
		offset = 0,
		scale = 1,
	...
	ab.create_2d_noise("cave2_" .. k .. "_route", {
		offset = 0,
		scale = 1,
		spread = {x=75, y=75, z=75},
		seed = pr:next(10, 1000),
	...
	ab.create_2d_noise("cave2_" .. k .. "_height", {
		offset = 0,
		scale = 1,
		spread = {x=256, y=256, z=256},
		seed = pr:next(10, 1000),
	...
	ab.create_2d_noise("cave3_" .. k .. "_route", {
		offset = 0,
		scale = 1,
		spread = {x=75, y=75, z=75},
		seed = pr:next(10, 1000),
	...
	ab.create_2d_noise("cave3_" .. k .. "_height", {
		offset = 0,
		scale = 1,
		spread = {x=256, y=256, z=256},
		seed = pr:next(10, 1000),
...
function ab.prepare_tunnels(bp2d, sides2D, minp, maxp)
	local caves = {}
	...
	for k = 1, num do
		...
		if good then
			...
			caves[#caves + 1] = {
				{
					routemap = ab.get_2d_noise(bp2d, sides2D, "cave1_" .. k .. "_route"),
					heightmap = ab.get_2d_noise(bp2d, sides2D, "cave1_" .. k .. "_height"),
					y_level = y_level - 10,
				},
				{
					routemap = ab.get_2d_noise(bp2d, sides2D, "cave2_" .. k .. "_route"),
					heightmap = ab.get_2d_noise(bp2d, sides2D, "cave2_" .. k .. "_height"),
					y_level = y_level,
				},
				{
					routemap = ab.get_2d_noise(bp2d, sides2D, "cave3_" .. k .. "_route"),
					heightmap = ab.get_2d_noise(bp2d, sides2D, "cave3_" .. k .. "_height"),
					y_level = y_level + 10,
				},
			}
		end
...
function ab.generate_tunnels(vm, minp, maxp, seed)
	...
	local caves = ab.prepare_tunnels(bp2d, sides2D, minp, maxp)

	local noisemap1 = ab.get_2d_noise(bp2d, sides2D, "cave_n1")
	local noisemap2 = ab.get_2d_noise(bp2d, sides2D, "cave_n2")
	local noisemap4 = ab.get_3d_noise(bp3d, sides3D, "cave_n4")
