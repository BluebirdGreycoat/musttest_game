...
ambiance.allsounds = {
	...
	{name="wind1",          gain=1.0, miny=-15,    maxy=32000,  time="day",     indoors=false, },
	{name="wind2",          gain=1.0, miny=-15,    maxy=32000,  time="day",     indoors=false, },
	{name="desertwind",     gain=1.0, miny=-15,    maxy=32000,  time="day",     indoors=false, },
	{name="wind1",          gain=1.0, miny=-15,    maxy=32000,  time="night",   indoors=false, mintime=20, maxtime=50, },
	{name="wind2",          gain=1.0, miny=-15,    maxy=32000,  time="night",   indoors=false, mintime=20, maxtime=50, },
	...
	{name="cricket",        gain=1.0, miny=-10,    maxy=32000,  time="night",   indoors=false, },
	{name="jungle_night_1", gain=1.0, miny=-10,    maxy=32000,  time="night",   indoors=false, },
	{name="cardinal",       gain=1.0, miny=-10,    maxy=32000,  time="liminal", indoors=false, mintime=20, maxtime=60, },
	{name="crestedlark",    gain=1.0, miny=-10,    maxy=32000,  time="liminal", indoors=false, mintime=20, maxtime=60, },
	{name="deer",           gain=1.0, miny=-10,    maxy=32000,  time="night",   indoors=false, mintime=20, maxtime=120, },
	{name="frog",           gain=0.7, miny=-10,    maxy=32000,  time="liminal", indoors=false, },
	{name="robin",          gain=1.0, miny=-10,    maxy=32000,  time="liminal", indoors=false, },
	{name="bluejay",        gain=1.0, miny=-10,    maxy=32000,  time="liminal", indoors=false, },
	{name="gull",           gain=1.0, miny=-10,    maxy=32000,  time="liminal", indoors=false, },
	{name="peacock",        gain=1.0, miny=-10,    maxy=32000,  time="liminal", indoors=false, },
	{name="canadianloon1",  gain=1.0, miny=-10,    maxy=32000,  time="night",   indoors=false, mintime=120, maxtime=360, },
