...
local FORMTABLE = {
	...
	children = {
		...
		{label="Mark Dueling Arena", name="pvp_arena", selected="false", type="checkbox", x=0, y=0},
		{label="Signal Nearby Keys", name="hud_beacon", selected="false", type="checkbox", x=0, y=0.4},
		{type="container_end"},
		{type="container", x=4.76, y=3.37},
		{h=1, FORMID="configlist", inventory_location="current_player", list_name="craft", type="list", w=1, x=0, y=0},
		...
		{h=0.8, label="Manage Claims", name="manage_claims", style={bgcolor="brown"}, type="button_exit", w=2.4, x=7.9, y=0.9},
