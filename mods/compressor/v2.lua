...
for j, t in ipairs({
	...
	local func = _G["comp2_" .. t.tier]

	-- Read values from balancing table.
	local techname = "compressor_" .. t.tier
	...
	func.on_timer = function(pos, elapsed)
		...
		do
			if keeprunning then
				...
				machines.swap_node(pos, "comp2:" .. t.tier .. "_active")
	...
	func.on_blast = function(pos)
		...
		drops[#drops+1] = "comp2:" .. t.tier .. "_inactive"
...
if not comp2.run_once then
	for j, t in ipairs({
		...
		for k, v in ipairs({
			{name="inactive", light=0, tile="compressor_" .. t.tier .. "_front.png"},
			{name="active", light=8, tile="compressor_" .. t.tier .. "_front_active.png"},
		}) do
			minetest.register_node(":comp2:" .. t.tier .. "_" .. v.name, {
				description = t.up .. " " .. MACHINE_NAME .. "\n\n" .. MACHINE_DESC,
				tiles = {
					"compressor_" .. t.tier .. "_top.png",  "compressor_" .. t.tier .. "_bottom.png",
					"compressor_" .. t.tier .. "_side.png", "compressor_" .. t.tier .. "_side.png",
					"compressor_" .. t.tier .. "_side.png", v.tile,
				},
