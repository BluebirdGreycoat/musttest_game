...
for j, t in ipairs({
	{tier="lv", up="LV", speed=2.0, level=1, buffer=1000, demand=100},
	...
	local func = _G["ecfurn2_" .. t.tier]

	-- Read values from balancing table.
	local techname = "furnace_" .. t.tier
	...
	func.on_timer = function(pos, elapsed)
		...
		do
			if keeprunning then
				...
				local swapped = machines.swap_node(pos, "ecfurn2:" .. t.tier .. "_active")
				...
				meta:set_int("fueltotaltime", 0)
				meta:set_float("srctime", 0)
				machines.swap_node(pos, "ecfurn2:" .. t.tier .. "_inactive")
	...
	func.on_blast = function(pos)
		...
		drops[#drops+1] = "ecfurn2:" .. t.tier .. "_inactive"
...
if not ecfurn2.run_once then
	for j, t in ipairs({
		...
		for k, v in ipairs({
			{name="inactive", light=0, tile="electric_furnace_" .. t.tier .. "_front.png"},
			{name="active", light=8, tile="electric_furnace_front_" .. t.tier .. "_active.png"},
		}) do
			...
			minetest.register_node(":ecfurn2:" .. t.tier .. "_" .. v.name, {
				description = t.up .. " " .. MACHINE_NAME .. "\n\n" .. MACHINE_DESC,
				tiles = {
					"electric_furnace_" .. t.tier .. "_top.png",  "electric_furnace_" .. t.tier .. "_bottom.png",
					"electric_furnace_" .. t.tier .. "_side.png", "electric_furnace_" .. t.tier .. "_side.png",
					"electric_furnace_" .. t.tier .. "_side.png", v.tile,
				},
	...
	local c = "ecfurn2:core"
	local f = ecfurn2.modpath .. "/v2.lua"
	reload.register_file(c, f, false)

	ecfurn2.run_once = true
end
