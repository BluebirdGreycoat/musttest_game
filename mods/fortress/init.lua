...
dofile(fortress.modpath .. "/gen.v2.notify.lua")
dofile(fortress.modpath .. "/gen.v2.map.lua")
dofile(fortress.modpath .. "/gen.v2.sql.lua")
...
if not fortress.run_once then
	...
	minetest.register_chatcommand("genfort", {
		params = "",
		show_help = function(...) fortress.v2.show_command_help(...) end,
		description = "Fort generator manual spawn.",
		privs = {server=true},
