...
minetest.register_node("moretrees:birch_sapling", {
    ...
    on_timer = function(pos, elapsed)
		...
		hb4.leafscatter.remove(pos, SCHEMATIC_MINP, SCHEMATIC_MAXP, "moretrees:birch_leaves", math.random(10, 30))
		hb4.leafscatter.add(pos, SCHEMATIC_MINP, SCHEMATIC_MAXP, "moretrees:birch_leaves", math.random(10, 30))
...
minetest.register_craft({
    ...
    recipe = {
        {"default:stick", "moretrees:birch_wood", "default:stick"},
        {"default:stick", "moretrees:birch_wood", "default:stick"}
    }
})
