...
minetest.register_node("moretrees:poplar_sapling", {
    ...
    on_timer = function(pos, elapsed)
				if mtflower.can_grow(pos) then
					if mtflower.try_grow(pos, "moretrees:poplar_tree", "moretrees:poplar_leaves", "glowstone:minerals", "glowstone:minerals") then
						return
					end
				end
		...
		hb4.leafscatter.remove(pos, SCHEMATIC_MINP, SCHEMATIC_MAXP, "moretrees:poplar_leaves", math_random(10, 30))
		hb4.leafscatter.add(pos, SCHEMATIC_MINP, SCHEMATIC_MAXP, "moretrees:poplar_leaves", math_random(10, 30))
...
minetest.register_craft({
    ...
    recipe = {
        {"techcrafts:hinge_wood", "moretrees:poplar_wood", "group:stick"},
