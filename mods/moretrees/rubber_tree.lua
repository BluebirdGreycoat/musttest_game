...
minetest.register_node("moretrees:rubber_tree_sapling", {
    ...
    on_timer = function(pos, elapsed)
				if mtflower.can_grow(pos) then
					if mtflower.try_grow(pos, "moretrees:rubber_tree_tree", "moretrees:rubber_tree_leaves", "glowstone:minerals", "glowstone:minerals") then
						return
					end
				end
		...
		hb4.leafscatter.remove(pos, SCHEMATIC_MINP, SCHEMATIC_MAXP, "moretrees:rubber_tree_leaves", math_random(10, 30))
		hb4.leafscatter.add(pos, SCHEMATIC_MINP, SCHEMATIC_MAXP, "moretrees:rubber_tree_leaves", math_random(10, 30))
...
minetest.register_craft({
    ...
    recipe = {
        {"techcrafts:hinge_wood", "moretrees:rubber_tree_wood", "group:stick"},
        {"group:stick", "moretrees:rubber_tree_wood", "group:stick"}
    }
})
