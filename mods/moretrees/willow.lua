...
minetest.register_node("moretrees:willow_sapling", {
    ...
    on_timer = function(pos, elapsed)
		...
		hb4.leafscatter.remove(pos, SCHEMATIC_MINP, SCHEMATIC_MAXP, "moretrees:willow_leaves", math.random(10, 30))
		hb4.leafscatter.add(pos, SCHEMATIC_MINP, SCHEMATIC_MAXP, "moretrees:willow_leaves", math.random(10, 30))
...
minetest.register_craft({
    ...
    recipe = {
        {"default:stick", "moretrees:willow_wood", "default:stick"},
        {"default:stick", "moretrees:willow_wood", "default:stick"}
    }
})
