...
minetest.register_node("real_torch:torch", {
  ...
  on_place = function(...)
	...
	on_ignite = function(pos, igniter)
		...
		minetest.set_node(pos, {name = "torches:torch_floor", param2 = nod.param2})
	end,
})
...
minetest.register_node("real_torch:torch_wall", {
	...
	on_ignite = function(pos, igniter)
		local nod = minetest.get_node(pos)
		minetest.set_node(pos, {name = "torches:torch_wall", param2 = nod.param2})
	end,
  on_flood = function(pos, oldnode, newnode)
    minetest.set_node(pos, {name="air"})
    minetest.sound_play("real_torch_extinguish", {pos=pos, max_hear_distance=16, gain=1})
...
minetest.register_node("real_torch:torch_ceiling", {
	...
	on_ignite = function(pos, igniter)
		local nod = minetest.get_node(pos)
		minetest.set_node(pos, {name = "torches:torch_ceiling", param2 = nod.param2})
	end,
  on_flood = function(pos, oldnode, newnode)
    minetest.set_node(pos, {name="air"})
    minetest.sound_play("real_torch_extinguish", {pos=pos, max_hear_distance=16, gain=1})
