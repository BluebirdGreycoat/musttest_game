...
-- unlit floor torch
minetest.register_node("real_torch:kalite_torch", {
	description = "Kalite Torch (Unlit)",
	drawtype = "mesh",
  ...
  _torches_node_floor = "real_torch:kalite_torch",
  _torches_node_wall = "real_torch:kalite_torch_wall",
...
-- unlit wall torch
minetest.register_node("real_torch:kalite_torch_wall", {
	drawtype = "mesh",
	mesh = "torch_wall.obj",
	tiles = {{
		    name = "real_torch_on_floor.png",
...
-- unlit ceiling torch
minetest.register_node("real_torch:kalite_torch_ceiling", {
	drawtype = "mesh",
...
minetest.override_item("torches:kalite_torch_floor", {
...
minetest.override_item("torches:kalite_torch_wall", {
...
minetest.override_item("torches:kalite_torch_ceiling", {
