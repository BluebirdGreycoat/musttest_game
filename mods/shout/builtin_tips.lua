...
shout.BUILTIN_HINTS = {
	...
	"See '/help channel' for information on setting up and using custom chatrooms.",
	"Stamina comes back faster when you are not hungry and resting in one place.",
	"Use the /players command when part of a group channel to see others on your channel.",
