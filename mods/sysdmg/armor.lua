...
sysdmg.wear_groups = {
  ...
  ["shields:shield_carbon"]        = {fall=0.5, snappy=0.6, fleshy=0.4, freeze=1.25, ground=0.0, boom=3.0},
  ["3d_armor:helmet_carbon"]       = {fall=0.5, snappy=0.6, fleshy=0.4, freeze=1.25, crush=3.0, ground=0.0},
  ["3d_armor:chestplate_carbon"]   = {fall=0.5, snappy=0.6, fleshy=0.4, freeze=1.25, ground=0.0, boom=4.0},
  ["3d_armor:leggings_carbon"]     = {fall=1.25,snappy=0.6, fleshy=0.4, freeze=1.25, },
  ["3d_armor:boots_carbon"]        = {fall=1.5, snappy=0.6, fleshy=0.4, freeze=1.25, ground=2.0},
...
sysdmg.resist_groups = {
  ...
  ["shields:shield_steel"]         = {fleshy=10, snappy=10, freeze=5},
  ["3d_armor:helmet_steel"]        = {fleshy=10, snappy=10, freeze=5},
  ["3d_armor:chestplate_steel"]    = {fleshy=15, snappy=15, freeze=5},
  ["3d_armor:leggings_steel"]      = {fleshy=15, snappy=15, freeze=5},
  ["3d_armor:boots_steel"]         = {fleshy=10, snappy=10, freeze=5},

  ["shields:shield_carbon"]        = {fleshy=12, snappy=10, arrow=18},
  ["3d_armor:helmet_carbon"]       = {fleshy=12, snappy=15, arrow=15},
  ["3d_armor:chestplate_carbon"]   = {fleshy=17, snappy=15, arrow=20},
  ["3d_armor:leggings_carbon"]     = {fleshy=17, snappy=15, arrow=15},
  ["3d_armor:boots_carbon"]        = {fleshy=12, snappy=10, arrow=12},
