...
sysdmg.wear_groups = {
  ["shields:shield_wood"]          = {fall=0.5, freeze=0.1, heat=2.0, ground=0.0, boom=3.0},
  ["shields:shield_enhanced_wood"] = {fall=0.5, freeze=0.1, heat=2.0, ground=0.0, boom=3.0},
  ["3d_armor:helmet_wood"]         = {fall=0.5, freeze=0.1, crush=3.0, heat=2.0, ground=0.0},
  ["3d_armor:chestplate_wood"]     = {fall=0.5, freeze=0.1, heat=2.0, ground=0.0, boom=4.0},
  ["3d_armor:leggings_wood"]       = {fall=1.25,freeze=0.1, heat=2.0},
  ["3d_armor:boots_wood"]          = {fall=1.5, freeze=0.1, heat=2.0, ground=2.0},

  ["shields:shield_steel"]         = {fall=0.5, fleshy=0.5, freeze=1.25, ground=0.0, boom=3.0},
  ["3d_armor:helmet_steel"]        = {fall=0.5, fleshy=0.5, freeze=1.25, crush=3.0, ground=0.0},
  ["3d_armor:chestplate_steel"]    = {fall=0.5, fleshy=0.5, freeze=1.5, ground=0.0, boom=4.0},
  ["3d_armor:leggings_steel"]      = {fall=1.25,fleshy=0.5, freeze=1.25, },
  ["3d_armor:boots_steel"]         = {fall=1.5, fleshy=0.5, freeze=1.25, ground=2.0},

  ["shields:shield_carbon"]        = {fall=0.5, fleshy=0.4, freeze=1.25, ground=0.0, boom=3.0},
  ["3d_armor:helmet_carbon"]       = {fall=0.5, fleshy=0.4, freeze=1.25, crush=3.0, ground=0.0},
  ["3d_armor:chestplate_carbon"]   = {fall=0.5, fleshy=0.4, freeze=1.25, ground=0.0, boom=4.0},
  ["3d_armor:leggings_carbon"]     = {fall=1.25,fleshy=0.4, freeze=1.25, },
  ["3d_armor:boots_carbon"]        = {fall=1.5, fleshy=0.4, freeze=1.25, ground=2.0},
  ...
  ["shields:shield_diamond"]       = {fall=0.5, ground=0.0, boom=3.0},
  ["3d_armor:helmet_diamond"]      = {fall=0.5, crush=3.0, ground=0.0},
  ["3d_armor:chestplate_diamond"]  = {fall=0.5, ground=0.0, boom=4.0},
  ...
  ["shields:shield_mithril"]       = {fall=0.5, fleshy=0.5, ground=0.0, boom=3.0},
  ["3d_armor:helmet_mithril"]      = {fall=0.5, fleshy=0.5, crush=3.0, ground=0.0},
  ["3d_armor:chestplate_mithril"]  = {fall=0.5, fleshy=0.5, ground=0.0, boom=4.0},
  ["3d_armor:leggings_mithril"]    = {fall=0.8, fleshy=0.5, },
  ["3d_armor:boots_mithril"]       = {fall=0.9, fleshy=0.5, ground=2.0},

  ["3d_armor:helmet_cotton"]       = {fall=0.5, freeze=0.1, crush=1.0, heat=2.0, ground=0.0},
  ["3d_armor:chestplate_cotton"]   = {fall=0.5, freeze=0.1, heat=2.0, ground=0.0, boom=4.0},
  ["3d_armor:leggings_cotton"]     = {fall=0.7, freeze=0.1, heat=2.0},
  ["3d_armor:boots_cotton"]        = {fall=1.0, freeze=0.1, heat=2.0, ground=2.0},

  ["3d_armor:helmet_leather"]      = {fall=0.5, freeze=0.1, crush=1.0, heat=2.0, ground=0.0},
  ["3d_armor:chestplate_leather"]  = {fall=0.5, freeze=0.1, heat=2.0, ground=0.0, boom=4.0},
  ["3d_armor:leggings_leather"]    = {fall=0.7, freeze=0.1, heat=2.0},
  ["3d_armor:boots_leather"]       = {fall=1.0, freeze=0.1, heat=2.0, ground=2.0},
}
...
sysdmg.resist_groups = {
  ["shields:shield_wood"]          = {fleshy=5,  poison=5,  freeze=10, heat=-10},
  ["shields:shield_enhanced_wood"] = {fleshy=8,  poison=5,  freeze=20, heat=-5},
  ["3d_armor:helmet_wood"]         = {fleshy=5,  poison=15, freeze=15, heat=-5},
  ["3d_armor:chestplate_wood"]     = {fleshy=10, poison=15, freeze=25, heat=-15},
  ["3d_armor:leggings_wood"]       = {fleshy=5,  poison=10, freeze=10, heat=-10},
  ["3d_armor:boots_wood"]          = {fleshy=5,  poison=5,  freeze=15, heat=-5},

  ["shields:shield_steel"]         = {fleshy=10, freeze=5, shock=50},
  ["3d_armor:helmet_steel"]        = {fleshy=10, freeze=5, arrow=50},
  ["3d_armor:chestplate_steel"]    = {fleshy=15, freeze=5, arrow=50},
  ["3d_armor:leggings_steel"]      = {fleshy=15, freeze=5},
  ["3d_armor:boots_steel"]         = {fleshy=10, freeze=5},

  ["shields:shield_carbon"]        = {fleshy=12, arrow=18, shock=50},
  ["3d_armor:helmet_carbon"]       = {fleshy=12, arrow=25},
  ["3d_armor:chestplate_carbon"]   = {fleshy=17, arrow=30},
  ["3d_armor:leggings_carbon"]     = {fleshy=17, arrow=15},
  ["3d_armor:boots_carbon"]        = {fleshy=12, arrow=12},

  ["shields:shield_bronze"]        = {fleshy=10, arrow=50,   boom=20, heat=6},
  ["3d_armor:helmet_bronze"]       = {fleshy=10, freeze=12,  boom=12, heat=6},
  ["3d_armor:chestplate_bronze"]   = {fleshy=15, freeze=20,  boom=20, heat=16},
  ["3d_armor:leggings_bronze"]     = {fleshy=15, freeze=12,  boom=10, heat=6},
  ["3d_armor:boots_bronze"]        = {fleshy=10, freeze=8,   boom=10, heat=6},

  ["shields:shield_diamond"]       = {fleshy=15, shock=-3,  crush=15, arrow=15, boom=-5},
  ["3d_armor:helmet_diamond"]      = {fleshy=15, shock=-3,  crush=20, arrow=20, boom=-10},
  ["3d_armor:chestplate_diamond"]  = {fleshy=20, shock=-15, crush=20, arrow=20, boom=-15},
  ["3d_armor:leggings_diamond"]    = {fleshy=20, shock=-3,  crush=15, arrow=6 , boom=-5},
  ["3d_armor:boots_diamond"]       = {fleshy=15, shock=-3,  crush=15, arrow=6 , boom=-5},

  -- Gold armor is weak to freezing.
  ["shields:shield_gold"]          = {fleshy=10, heat=8, freeze=-5},
  ["3d_armor:helmet_gold"]         = {fleshy=10, heat=8, freeze=-10},
  ["3d_armor:chestplate_gold"]     = {fleshy=15, heat=8, freeze=-15},
  ["3d_armor:leggings_gold"]       = {fleshy=15, heat=8, freeze=-8},
  ["3d_armor:boots_gold"]          = {fleshy=10, heat=8, freeze=-5},

  ["shields:shield_mithril"]       = {boom=10, shock=-10, fleshy=15, arrow=50},
  ["3d_armor:helmet_mithril"]      = {boom=5,  shock=-10, fleshy=20, arrow=60},
  ["3d_armor:chestplate_mithril"]  = {boom=10, shock=-10, fleshy=25, arrow=25},
  ["3d_armor:leggings_mithril"]    = {boom=5,  shock=-10, fleshy=25},
  ["3d_armor:boots_mithril"]       = {boom=5,  shock=-10, fleshy=20},

  ["3d_armor:helmet_cotton"]       = {fleshy=5,  freeze=17, heat=20, arrow=-15},
  ["3d_armor:chestplate_cotton"]   = {fleshy=5,  freeze=28, heat=20, arrow=-20},
  ["3d_armor:leggings_cotton"]     = {fleshy=5,  freeze=15, heat=20, arrow=-10},
  ["3d_armor:boots_cotton"]        = {fleshy=5,  freeze=20, heat=20, arrow=-5},

  ["3d_armor:helmet_leather"]      = {fleshy=7,  freeze=22, heat=20, arrow=-8},
  ["3d_armor:chestplate_leather"]  = {fleshy=7,  freeze=30, heat=20, arrow=-10},
  ["3d_armor:leggings_leather"]    = {fleshy=7,  freeze=18, heat=20, arrow=-5},
  ["3d_armor:boots_leather"]       = {fleshy=7,  freeze=21, heat=20, arrow=-2},
}
