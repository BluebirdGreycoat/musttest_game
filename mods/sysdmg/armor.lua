...
sysdmg.wear_groups = {
  ["shields:shield_wood"]          = {fall=0.5, punch=1.25, lava=4.0, heat=2.0, ground=0.0, boom=3.0},
  ["shields:shield_enhanced_wood"] = {fall=0.5, punch=1.25, lava=4.0, heat=2.0, ground=0.0, boom=3.0},
  ["3d_armor:helmet_wood"]         = {fall=0.5, punch=1.25, lava=4.0, crush=3.0, heat=2.0, ground=0.0},
  ["3d_armor:chestplate_wood"]     = {fall=0.5, punch=1.25, lava=4.0, heat=2.0, ground=0.0, boom=4.0},
  ["3d_armor:leggings_wood"]       = {fall=1.25,punch=1.25, lava=4.0,  heat=2.0},
  ["3d_armor:boots_wood"]          = {fall=1.5, punch=1.25, lava=4.0, heat=2.0, ground=2.0},

  ["shields:shield_steel"]         = {fall=0.5, lava=2.0, punch=1.25, ground=0.0, boom=3.0},
  ["3d_armor:helmet_steel"]        = {fall=0.5, lava=2.0, crush=3.0, ground=0.0},
  ["3d_armor:chestplate_steel"]    = {fall=0.5, lava=2.0, punch=1.5, ground=0.0, boom=4.0},
  ["3d_armor:leggings_steel"]      = {fall=1.25,lava=2.0,  },
  ["3d_armor:boots_steel"]         = {fall=1.5, lava=2.0, ground=2.0},

  ["shields:shield_carbon"]        = {fall=0.5, lava=1.5, punch=1.25, ground=0.0, boom=3.0},
  ["3d_armor:helmet_carbon"]       = {fall=0.5, lava=1.5, crush=3.0, ground=0.0},
  ["3d_armor:chestplate_carbon"]   = {fall=0.5, lava=1.5, punch=1.5, ground=0.0, boom=4.0},
  ["3d_armor:leggings_carbon"]     = {fall=1.25,lava=1.5,  },
  ["3d_armor:boots_carbon"]        = {fall=1.5, lava=1.5, ground=2.0},

  ["shields:shield_bronze"]        = {fall=0.5, punch=1.25, ground=0.0, boom=0.5},
  ["3d_armor:helmet_bronze"]       = {fall=0.5, crush=3.0, ground=0.0,  boom=0.5},
  ["3d_armor:chestplate_bronze"]   = {fall=0.5, punch=1.5, ground=0.0,  boom=0.5},
  ["3d_armor:leggings_bronze"]     = {fall=1.25,                        boom=0.5},
  ["3d_armor:boots_bronze"]        = {fall=1.5, ground=2.0,             boom=0.5},
  ...
  ["shields:shield_gold"]          = {fall=0.5, lava=0.3, heat=0.1, punch=1.25, ground=0.0, boom=3.0},
  ["3d_armor:helmet_gold"]         = {fall=0.5, lava=0.3, heat=0.1, crush=3.0, ground=0.0},
  ["3d_armor:chestplate_gold"]     = {fall=0.5, lava=0.3, heat=0.1, punch=1.5, ground=0.0, boom=4.0},
