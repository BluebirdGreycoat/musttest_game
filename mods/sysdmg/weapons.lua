...
sysdmg.damage_groups = {
  ...
  ["moreores:pick_silver"]    = {snappy=12.0*SCALE, freeze=0.2*SCALE, fleshy=0.2*SCALE, knockback= 1.5*KNB},
  ...
  ["default:axe_mese"]        = {choppy=0.2*SCALE, snappy=0.2*SCALE, knockback=2.9*KNB},
  ["default:axe_diamond"]     = {choppy=7.0*SCALE, snappy=0.2*SCALE, knockback=2.9*KNB},
  ["moreores:axe_silver"]     = {shock=2.0*SCALE, choppy=0.2*SCALE, freeze=0.2*SCALE, snappy=0.2*SCALE, knockback=2.9*KNB},
  ...
  ["default:sword_mese"]      = {fleshy=0.2*SCALE, snappy=0.2*SCALE, knockback=1.3*KNB},
  ["default:sword_diamond"]   = {fleshy= 8.0*SCALE, snappy=0.2*SCALE, knockback=1.3*KNB},
  ["moreores:sword_silver"]   = {shock=6.0*SCALE, fleshy=0.2*SCALE, freeze=0.2*SCALE, snappy=0.2*SCALE, knockback=1.3*KNB},
