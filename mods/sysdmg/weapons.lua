...
sysdmg.damage_groups = {
  ...
  ["default:pick_wood"]       = {snappy= 2.0*SCALE, fleshy=0.2*SCALE, },
  ["default:pick_stone"]      = {snappy= 1.0*SCALE, fleshy=0.2*SCALE, knockback= 8},
  ["default:pick_steel"]      = {snappy=13.0*SCALE, fleshy=0.2*SCALE, knockback= 3},
  ["default:pick_bronze"]     = {snappy=13.0*SCALE, fleshy=0.2*SCALE, knockback= 3},
  ["default:pick_bronze2"]    = {snappy=13.0*SCALE, fleshy=0.2*SCALE, knockback= 3},
  ["default:pick_mese"]       = {snappy=16.0*SCALE, crumbly=0.2*SCALE, fleshy=0.2*SCALE, knockback= 3},
  ["default:pick_diamond"]    = {snappy=17.0*SCALE, fleshy=0.2*SCALE, knockback= 3},
  ["moreores:pick_silver"]    = {snappy=12.0*SCALE, crumbly=0.2*SCALE, fleshy=0.2*SCALE, knockback= 3},
  ["moreores:pick_mithril"]   = {snappy=19.0*SCALE, fleshy=0.2*SCALE, knockback= 3},
  ["titanium:pick"]           = {snappy=15.0*SCALE, fleshy=0.2*SCALE, knockback= 6},
  ["gems:pick_ruby"]          = {snappy=17.1*SCALE, fleshy=0.2*SCALE, knockback= 6},
  ["gems:rf_pick_ruby"]       = {snappy=17.0*SCALE, fleshy=0.1*SCALE, knockback= 5},
  ["gems:pick_amethyst"]      = {snappy=16.1*SCALE, fleshy=0.2*SCALE, knockback= 6},
  ["gems:rf_pick_amethyst"]   = {snappy=16.0*SCALE, fleshy=0.1*SCALE, knockback= 5},
  ["gems:pick_sapphire"]      = {snappy=17.1*SCALE, fleshy=0.2*SCALE, knockback= 6},
  ["gems:rf_pick_sapphire"]   = {snappy=17.0*SCALE, fleshy=0.1*SCALE, knockback= 5},
  ["gems:pick_emerald"]       = {snappy=16.1*SCALE, fleshy=0.2*SCALE, knockback= 6},
  ["gems:rf_pick_emerald"]    = {snappy=16.0*SCALE, fleshy=0.1*SCALE, knockback= 5},

  ["default:shovel_stone"]    = {cracky=1.0*SCALE, fleshy=0.1*SCALE, crush=0.2*SCALE, knockback=16},
  ...
  ["default:shovel_mese"]     = {cracky=5.0*SCALE, crumbly=0.2*SCALE, fleshy=0.1*SCALE, crush=0.2*SCALE, knockback= 6},
  ...
  ["default:axe_stone"]       = {fleshy=1.0*SCALE, snappy=0.2*SCALE, knockback=4},
  ...
  ["default:axe_mese"]        = {fleshy=6.0*SCALE, crumbly=0.2*SCALE, snappy=0.2*SCALE, knockback=1},
  ["default:axe_diamond"]     = {fleshy=7.0*SCALE, snappy=0.2*SCALE, knockback=1},
  ["moreores:axe_silver"]     = {fleshy=2.0*SCALE, crumbly=0.2*SCALE, snappy=0.2*SCALE, knockback=1},
  ...
  ["default:sword_stone"]     = {cracky= 4.0*SCALE, fleshy=0.2*SCALE, knockback=6},
  ...
  ["default:sword_mese"]      = {fleshy= 8.0*SCALE, crumbly=0.2*SCALE, snappy=0.2*SCALE, knockback=1},
  ["default:sword_diamond"]   = {fleshy= 8.0*SCALE, snappy=0.2*SCALE, knockback=1},
  ["moreores:sword_silver"]   = {fleshy= 6.0*SCALE, crumbly=0.2*SCALE, snappy=0.2*SCALE, knockback=1},
  ...
  ["gems:sword_ruby"]         = {fleshy= 8.1*SCALE, snappy=0.2*SCALE, knockback=1},
  ["gems:rf_sword_ruby"]      = {fleshy= 8.0*SCALE, snappy=0.1*SCALE, knockback=0.5},
  ["gems:sword_amethyst"]     = {fleshy= 9.1*SCALE, snappy=0.2*SCALE, knockback=1},
  ["gems:rf_sword_amethyst"]  = {fleshy= 9.0*SCALE, snappy=0.1*SCALE, knockback=0.5},
  ["gems:sword_sapphire"]     = {fleshy= 7.1*SCALE, snappy=0.2*SCALE, knockback=1},
  ["gems:rf_sword_sapphire"]  = {fleshy= 7.0*SCALE, snappy=0.1*SCALE, knockback=0.5},
  ["gems:sword_emerald"]      = {fleshy= 7.1*SCALE, snappy=0.2*SCALE, knockback=1},
