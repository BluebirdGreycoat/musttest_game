...
sysdmg.damage_groups = {
  ...
  ["moreores:axe_silver"]     = {shock=2.0*SCALE, choppy=0.2*SCALE, crumbly=0.2*SCALE, snappy=0.2*SCALE, knockback=2.9*KNB},
  ...
  ["moreores:sword_silver"]   = {shock=6.0*SCALE, fleshy=0.2*SCALE, crumbly=0.2*SCALE, snappy=0.2*SCALE, knockback=1.3*KNB},
