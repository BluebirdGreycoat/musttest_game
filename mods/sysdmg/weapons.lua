...
sysdmg.damage_groups = {
  ...
  ["default:axe_steel"]       = {choppy=5.0*SCALE, snappy=0.2*SCALE, knockback=2},
  ["default:axe_bronze"]      = {choppy=4.0*SCALE, snappy=0.2*SCALE, knockback=2},
  ["default:axe_bronze2"]     = {choppy=4.0*SCALE, snappy=0.2*SCALE, knockback=2},
  ["default:axe_mese"]        = {crumbly=6.0*SCALE, choppy=0.2*SCALE, snappy=0.2*SCALE, knockback=2},
  ...
  ["moreores:axe_mithril"]    = {choppy=9.0*SCALE, snappy=0.2*SCALE, knockback=2},
  ["titanium:axe"]            = {choppy=5.0*SCALE, snappy=0.2*SCALE, knockback=4},
  ["gems:axe_ruby"]           = {choppy=6.1*SCALE, snappy=0.2*SCALE, knockback=2.5},
  ["gems:rf_axe_ruby"]        = {choppy=6.0*SCALE, snappy=0.1*SCALE, knockback=1.5},
  ["gems:axe_amethyst"]       = {choppy=6.1*SCALE, snappy=0.2*SCALE, knockback=2.5},
  ["gems:rf_axe_amethyst"]    = {choppy=6.0*SCALE, snappy=0.1*SCALE, knockback=1.5},
  ["gems:axe_sapphire"]       = {choppy=7.1*SCALE, snappy=0.2*SCALE, knockback=2.5},
  ["gems:rf_axe_sapphire"]    = {choppy=7.0*SCALE, snappy=0.1*SCALE, knockback=1.5},
  ["gems:axe_emerald"]        = {choppy=7.1*SCALE, snappy=0.2*SCALE, knockback=2.5},
  ["gems:rf_axe_emerald"]     = {choppy=7.0*SCALE, snappy=0.1*SCALE, knockback=1.5},
  ...
  ["gems:sword_ruby"]         = {fleshy= 8.1*SCALE, snappy=0.3*SCALE, knockback=2},
  ["gems:rf_sword_ruby"]      = {fleshy= 8.0*SCALE, snappy=0.1*SCALE, knockback=0.5},
  ["gems:sword_amethyst"]     = {fleshy= 9.1*SCALE, snappy=0.3*SCALE, knockback=6},
  ["gems:rf_sword_amethyst"]  = {fleshy= 9.0*SCALE, snappy=0.1*SCALE, knockback=0.5},
  ["gems:sword_sapphire"]     = {fleshy= 7.1*SCALE, snappy=0.3*SCALE, knockback=2},
  ["gems:rf_sword_sapphire"]  = {fleshy= 7.0*SCALE, snappy=0.1*SCALE, knockback=0.5},
  ["gems:sword_emerald"]      = {fleshy= 7.1*SCALE, snappy=0.3*SCALE, knockback=2},
