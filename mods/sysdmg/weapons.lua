...
sysdmg.damage_groups = {
  ...
  ["default:shovel_mese"]     = {cracky=2.5*SCALE, fleshy=0.1*SCALE, crush=0.2*SCALE, knockback= 3*KNB},
  ["default:shovel_diamond"]  = {cracky=6.0*SCALE, fleshy=0.1*SCALE, crush=0.2*SCALE, knockback= 2.7*KNB},
  ["moreores:shovel_silver"]  = {cracky=2.0*SCALE, freeze=0.2*SCALE, fleshy=0.1*SCALE, crush=0.2*SCALE, knockback= 2.7*KNB},
