...
minetest.register_node("torches:perma_ktorch_floor", {
  ...
  drop = "torches:perma_ktorch_floor",
  ...
  sounds = default.node_sound_wood_defaults(),
	...
	_torches_node_floor = "torches:perma_ktorch_floor",
	_torches_node_wall = "torches:perma_ktorch_wall",
	_torches_node_ceiling = "torches:perma_ktorch_ceiling",
...
minetest.register_node("torches:perma_ktorch_wall", {
  drawtype = "mesh",
  mesh = "torch_wall.obj",
  tiles = {{
        name = "gloopores_kalite_torch_on_floor_animated.png",
...
minetest.register_node("torches:perma_ktorch_ceiling", {
  drawtype = "mesh",
...
minetest.register_craft({
  type = "fuel",
  recipe = "torches:perma_ktorch_floor",
  burntime = 4,
})
