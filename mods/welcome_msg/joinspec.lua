...
joinspec.data = {
	warning = "Welcome to the frontier, Stranger! You have arrived on Enyekala (Must Test), an advanced survival-mode game built on top of the Minetest Project (https://www.minetest.net/).\n\n" ..
		...
		"The above is a coarse outline of your path through the Outback. The patient adventurer may wish to make some detours. Survivial in the overworld is much harder than making a living in the Outback. The better your supplies that you bring with you through the dimensional gate, the better your chances in the overworld will be. Consider stockpiling food, weaponry, rare items, and farming materials. Keep in mind that the portal’s exit coordinates change from time to time, and you cannot rely on there being any infrastructure to support you once you arrive at the other side. Until you meet others, this is hard-core PvE survival!\n\n" ..
